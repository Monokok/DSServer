# Сервер для приложения автошколы

Управления занятиями в автошколе: планирование, запись студентов и ведение расписания преподавателей.  
Разработано в рамках курса «Разработка Интернет-приложений» и "Разработка Андроид-приложений".
